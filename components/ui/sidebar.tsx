...
import { BanknoteArrowDown, Link, PanelLeftIcon, Receipt } from "lucide-react"
  ...
  return (
    <>
      <div
        ...
        {...props}
      />
      <div className="flex justify-first text-white rounded-lg bg-slate-800 mx-4 h-30 items-center justify-center gap-2 text-lg font-bold">
